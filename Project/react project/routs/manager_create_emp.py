...
def manager_create_emp_route(current_user):
    ...
    try:
        ...
        # 🚀 YAHAN CHANGE KIYA HAI: created_by column aur uski value add ki hai
        users_query = """
                INSERT INTO users (role, username, email, password, created_by)
                VALUES ('employee', %s, %s, %s, %s) 
        """
        users_values = (username, email, hashed_password, current_user['id'])
...
Your account has been successfully created with the role of 'Employee'. Below are your official login credentials:
